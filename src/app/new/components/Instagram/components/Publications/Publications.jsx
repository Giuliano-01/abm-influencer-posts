...
const Publications = () => {
  return (
    <PublicationsContainer>
      ...
      >
        <svg 
          aria-label="Cuando compartas fotos, aparecerán en tu perfil." 
          fill="currentColor" 
          height="62" 
          role="img" 
          viewBox="0 0 96 96" 
          width="62"
        >
          <title>Cuando compartas fotos, aparecerán en tu perfil.</title>
      ...
      <div>
        <span dir="auto">Comparte fotos</span>
      </div>
      <div role="button" tabIndex="0">Comparte tu primera foto</div>
    </PublicationsContainer>
  )
}
